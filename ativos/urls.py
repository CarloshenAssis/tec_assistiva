...
urlpatterns = [
    ...
    path("etiquetas/", views.etiquetas_centro, name="etiquetas_centro"),
    path("etiquetas/folha/", views.etiquetas_folha, name="etiquetas_folha"),
    path("etiquetas/historico/", views.etiquetas_historico, name="etiquetas_historico"),
